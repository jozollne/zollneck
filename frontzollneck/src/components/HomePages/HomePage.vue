  ...
  <div class="app-background">
    <div class="flex flex-column align-items-center justify-content-center h-screen">
      <div class="flex align-items-center justify-content-center">
        <div class="md:pr-8">
          <p class="font-bold text-center md:text-left text-4xl md:text-7xl">
            Hi, ich bin John Zollner
          </p>
          <p class="text-xl md:text-4xl md:text-left text-center">
            Ich weiß definitiv
            <span class="font-bold text-center md:text-left text-indigo-300 line-through"
              >nicht</span
            >
            was ich tue :)
          </p>
      ...
      <div class="flex flex-wrap justify-content-center gap-5 align-items-center pt-3">
        <div class="icon-container flex flex-column sm:flex-row align-items-center">
          <img src="@/icons/Go-Logo_White.svg" alt="Go Icon" class="w-2rem xl:w-4rem" />
          <span class="pt-2 sm:pt-0 sm:pl-2 text-xs xl:text-3xl font-bold">3+ Years</span>
        </div>
        <div class="icon-container flex flex-column sm:flex-row align-items-center">
          <img
            src="@/icons/c-sharp-16-svgrepo-com.svg"
            alt="C# Icon"
            class="w-2rem xl:w-4rem"
          />
          <span class="pt-2 sm:pt-0 sm:pl-2 text-xs xl:text-3xl font-bold">3+ Years</span>
        </div>
        <div class="icon-container flex flex-column sm:flex-row align-items-center">
          <img
            src="@/icons/javascript-16-svgrepo-com.svg"
            alt="JavaScript Icon"
            class="w-2rem xl:w-4rem"
          />
          <span class="pt-2 sm:pt-0 sm:pl-2 text-xs xl:text-3xl font-bold">4+ Years</span>
        </div>
        <div class="icon-container flex flex-column sm:flex-row align-items-center">
          <img
            src="@/icons/nestjs-svgrepo-com.svg"
            alt="NestJS Icon"
            class="w-2rem xl:w-4rem"
          />
          <span class="pt-2 sm:pt-0 sm:pl-2 text-xs xl:text-3xl font-bold">4+ Years</span>
        ...
        <div class="icon-container flex flex-column sm:flex-row align-items-center">
          <img
            ...
            class="w-2rem xl:w-4rem"
          />
          <span class="pt-2 sm:pt-0 sm:pl-2 text-xs xl:text-3xl font-bold">5+ Years</span>
        </div>
        <div class="icon-container flex flex-column sm:flex-row align-items-center">
          <img
            src="@/icons/vuejs-svgrepo-com.svg"
            alt="VueJS Icon"
            class="w-2rem xl:w-4rem"
          />
          <span class="pt-2 sm:pt-0 sm:pl-2 text-xs xl:text-3xl font-bold">5+ Years</span>
        ...
        <div class="icon-container flex flex-column sm:flex-row align-items-center">
          <img
            src="@/icons/jira-svgrepo-com.svg"
            alt="Jira Icon"
            class="w-2rem xl:w-4rem"
          />
          <span class="pt-2 sm:pt-0 sm:pl-2 text-xs xl:text-3xl font-bold">3+ Years</span>
        ...
        <div class="icon-container flex flex-column sm:flex-row align-items-center">
          <img
            src="@/icons/cisco-svgrepo-com.svg"
            alt="Cisco Icon"
            class="w-2rem xl:w-4rem"
          />
    ...
    <form
      ...
      class="flex flex-column align-items-stretch gap-4 p-2"
    >
      <div
        id="kontakt"
        class="flex align-items-center justify-content-center font-bold flex-column pt-8"
      >
